...
const PortfolioPage = () => {
  ...
  return (
    <motion.div className="h-full" initial={{y:"-200vh"}} animate={{y:"0%"}} transition={{duration: 1}}>
      <div className="h-[600vh]" ref={portRef}>
        <div className="w-screen h-[calc(100vh-6rem)] flex items-center justify-center text-8xl text-center" >My Personal Projects</div>
        <div className="sticky top-0 flex h-screen gap-4 items-center overflow-hidden">
          <motion.div style={ { x }} className="flex">
            <div className="h-screen w-screen flex items-center justify-center bg-gradient-to-r from-gray-300 to-green-300" />
          {
            constants.projects.map(project => (
              <div className="h-screen w-screen flex items-center justify-center bg-gradient-to-r from-gray-300 to-green-300" key={project.id}>
                <div className="flex flex-col gap-8 text-white">
                  <h1 className="text-xl md:text-4xl lg:text-6xl xl:text-8xl">{project.title}</h1>
      ...
      <div className="w-screen h-screen flex flex-col gap-16 items-center justify-center text-center">
        ...
        <div className="relative">
          <motion.svg animate={{rotate:360}} transition={{duration: 8, ease:'linear', repeat: Infinity}} viewBox="0 0 300 300" className="w-64 h-64 md:w-[500px] md:h-[500px]">
            ...
            <text fill="#000">
              <textPath xlinkHref="#circlePath" className="text-xl">- Full stack dev - Software Engineer</textPath>
            </text>
          </motion.svg>
